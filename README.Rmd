...
At present, the only function is `tamm_report()`. When provided a tamm file name and the path to the directory (defaults to using the current working directory), this generates an html report summarizing key aspects of the TAMM. The report is given the same name as the TAMM with the suffix "-Visualization". 
...
Still in the process of transfering experimental functions from NOF 2024 project.
Files to look at:
