...
tamm_diff = function(filename.1, filename.2, results.name, percent.digits = 1, numeric.digits = 1,
  ...
  if(spec.all == "chin")
  {
    tamm_diff_chin(filename.1 = filename.1, filename.2 = filename.2, results.name = results.name, percent.digits = percent.digits,
  ...
  if(spec.all == "coho"){
    tamm_diff_coho(filename.1 = filename.1, filename.2 = filename.2, results.name = results.name, percent.digits = percent.digits,
                   numeric.digits = numeric.digits,
                   numeric.digits.small = numeric.digits.small,
                   dim.override = dim.override,
                   wrap.text = wrap.text)
...
tamm_diff_chin = function(filename.1, filename.2, results.name, percent.digits = 1, numeric.digits = 1,
  ...
  f1 = format_key_tamm_sheets_chin(f1, percent.digits = percent.digits, numeric.digits = numeric.digits,
                                   numeric.digits.small = numeric.digits.small)
  f2 = read_key_tamm_sheets_chin(filename.2)
  f2 = format_key_tamm_sheets_chin(f2, percent.digits = percent.digits, numeric.digits = numeric.digits,
                                   numeric.digits.small = numeric.digits.small)
...
tamm_diff_coho = function(filename.1, filename.2, results.name, percent.digits = 1, numeric.digits = 1,
  ...
  f1 = format_key_tamm_sheets_coho(f1, percent.digits = percent.digits, numeric.digits = numeric.digits,
                                   numeric.digits.small = numeric.digits.small)
  f2 = read_key_tamm_sheets_coho(filename.2)
  f2 = format_key_tamm_sheets_coho(f2, percent.digits = percent.digits, numeric.digits = numeric.digits,
                                   numeric.digits.small = numeric.digits.small)
