...
tamm_format_input = function(wb, tabname = "input", wrap.text = FALSE){
  ...
  xldiff::cells_stylize(wb, sheet = tabname, style = openxlsx::createStyle(fgFill = "#f0f4f9"),
                        block.ranges = c("A11:O47", "A51:S72", "A75:P83", "A87:O94", "A99:H120",
  ...
  xldiff::cells_stylize(wb, sheet = tabname, style = openxlsx::createStyle(fontSize = 12, textDecoration = "bold"),
                        block.ranges = c("A11:O13", "A28:O29",
                                         "A39:O40", "A51:S52",
                                         "A75:O76", "A87:O88",
                                         "A99:H100", "A101", "A118",
  ...
  xldiff::cells_stylize(wb, sheet = tabname, style = openxlsx::createStyle(fgFill = "black"),
                        block.ranges = c("D102", "B159:B160", "B226", "G226:H226",
                                         "B238", "G238:H238", "B255", "G255:H255",
                                         "B262", "G262:H262"),
                        stack = TRUE)
  ...
  if(wrap.text){
    xldiff::cells_stylize(wb, sheet = tabname, style = openxlsx::createStyle(wrapText = TRUE),
...
tamm_format_wacoast = function(wb, tabname = "wacoast"){
  ...
  xldiff::cells_stylize(b, sheet = tabname, style = openxlsx::createStyle(fontSize = 12, textDecoration = "bold"),
                        block.ranges = c(
                          ...
                          ## third chunk: Hoh
                          "H29", "I30", "O30", "Q30", "G33", "M32", "Q32:R33", "N34:P34", "K34:K36", "I37", "M39", "O37", "N39:Q39", "Q37:Q38",
                          # Fourth chunk: Queets
                          "H43", "I44", "O44:Q44", "G48", "M46", "N47:P47", "Q46:R47", "K51", "O53:Q53", "I53", "M54", "N55:P55", "Q53:Q55"

                        ),
                        stack = TRUE)
  xldiff::add_cell_borders(wb = wb, sheet = tabname,
                           block.ranges = c( "G4:P10", "G12:P27",
                                             "G29:P41", "G43:P58",
                                             ...
                                             "V38:V40", "W38:AB40", "AC38:AC40", "V41:V47", "W41:AB47", "AC41:AC47"),
                           border.thickness = "thin",
                           every.cell = FALSE
  )
